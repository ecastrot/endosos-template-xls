...
Const APPLICATION As String = "EndososAJ"
...
Public Const K_COL_TOT As String = "C_T"
...
Public Function removePropertyFile(Path_INI As String, Key As String) As String
    WritePrivateProfileString APPLICATION, Key, vbNullString, Path_INI
End Function
